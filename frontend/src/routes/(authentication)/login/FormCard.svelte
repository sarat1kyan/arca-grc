...
<div class="flex flex-col w-7/8 lg:w-3/4 p-10 rounded-lg shadow-lg bg-white bg-opacity-[.90]">
	<div data-testid="login" class="flex flex-col w-full items-center space-y-4">
		...
		<h3
			class="font-bold leading-tight tracking-tight md:text-2xl bg-linear-to-r from-pink-500 to-blue-600 bg-clip-text text-transparent"
		>
		...
		{#if data.SSOInfo.is_enabled}
			...
			<button
				class="btn bg-linear-to-l from-blue-800 to-blue-400 text-white font-semibold w-1/2"
				onclick={() =>
